...
(function() {
  var addJump, create, d, drawCar, drawWithMouse, init, makeCar, makeLevel, preDrawACar, preload, rand, render, update, _DEBUG_, _car_, _game_, _graphics_, _h_, _jump_counter_, _level_, _nav_, _pos_back_wheel_, _pos_car_body_, _pos_front_wheel_, _speed_, _sprite_collector_, _w_;
  ...
  update = function() {
    ...
    if (_nav_.down.isDown) {
      d('v');
      _car_.main.body.angle = _car_.main.body.angle + 1;
      return _car_.main.body.angularVelocity = 0.0001;
    }
  };
